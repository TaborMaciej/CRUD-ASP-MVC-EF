    ...
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subjects != null ? 
                          ...
                          Problem("Entity set 'StudentsDbContext.Subjects'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StudentsDbContext.Subjects'  is null.");
            }
            var subject = await _context.Subjects.FindAsync(id);
            if (subject != null)
            {
                var subGrades = await _context.Grades.Where(g => g.SubjectID == id).ToListAsync();

                foreach (var grades in subGrades)
                {
